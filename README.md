...
- [x] 서비스별 ECR Repository 생성
- [x] 서비스별 Dockerfile 작성
- [x] GitHub Actions Workflow 작성
- [x] GitHub OIDC Provider 구성
- [x] ECR Push IAM Policy 구성
- [x] GitHub Actions IAM Role 구성
- [x] Repository 및 Branch 기반 Trust Policy 설정
- [x] GitHub Secrets 등록
- [x] 서비스별 Docker 이미지 빌드
- [x] ECR 이미지 Push 확인
- [x] Commit SHA 이미지 태그 적용
- [x] Kubernetes Namespace 정의
- [x] 서비스별 Deployment 및 Service 작성
- [x] ConfigMap 및 Secret 예제 작성
- [x] Kustomize 구성
- [x] EKS kubeconfig 연결
- [x] EKS Private Endpoint 접근 문제 확인

### 진행 중 및 남은 작업

- [ ] EKS API 접근 방식 확정
- [ ] Worker Node Label 적용
- [ ] 실제 Kubernetes Secret 생성
- [ ] Kubernetes Manifest EKS 적용
- [ ] 전체 Pod `Running` 상태 확인
- [ ] 서비스 간 내부 통신 확인
...
- 자동 Sync 구성
- Self Heal 및 Drift 감지
- 환경별 Kustomize Overlay 구성

### 4단계: 무중단 배포

- Argo Rollouts 설치
- Canary 또는 Blue-Green 전략 적용
- 배포 지표 수집
- 자동 승격 및 Rollback 기준 정의
